...
int main(int argc, char * argv[])
{
	...
	select_region_samples(1, "");
	select_region_samples(16, "");
	select_region_samples(17, "");
	select_region_samples(11, "");
	select_region_samples(12, "");
	select_region_samples(14, "");
	select_region_samples(6, "");
	select_region_samples(8, "");
	select_region_samples(7, "");
	select_region_samples(10, "");
	select_region_samples(13, "");
	select_region_samples(18, "");
