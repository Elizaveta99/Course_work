...
static void select_region_samples(int region_type, char* file_name)
{
	...
	{ // there is LBBB region in this record 
		...
		for (int i = 0; i < cntReg; i++)
		{
			...
			//  для окончательной записи в файл раскомментить
			...
			sum += (finish[i] - start[i]) * 360;	
		}
		printf("sum = %d\n", sum);
		//  для каждой записи в общую сумму (финиш - старт) посчитать - чтобы поделить/ в файл patalogies_4 записать,
		// сколько в каждой записи каждого из 4 классов
		fclose(file);
	}
...
int main(int argc, char * argv[])
{
	...
	//select_region_samples(1, "C:\\Users\\User\\Desktop\\data_files_test_4\\N");
	//select_region_samples(8, "C:\\Users\\User\\Desktop\\data_files_test_4\\AFIB");
	//select_region_samples(17, "C:\\Users\\User\\Desktop\\data_files_test_4\\RBBB");
	//select_region_samples(18, "C:\\Users\\User\\Desktop\\data_files_test_4\\V");
	select_region_samples(11, "C:\\Users\\User\\Desktop\\data_files_test_4\\B");
